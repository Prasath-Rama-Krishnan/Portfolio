...
function App() {
  const projects = [
    { id: 1, title: "Gamification with Education", description: "An interactive platform with educational games for creativity and learning.", image: image3, link: "https://prasathramakrishna.github.io/education-with-gamification/gamification/index.html" },
    { id: 2, title: "Streetlight Control System", description: "Automating streetlight operations with real-time control and status updates.", image: image2, link: "https://prasathramakrishna.github.io/streetlight-update/public/" },
    { id: 3, title: "Online Bookstore", description: "A responsive bookstore with search filters and a user-friendly UI.", image: image1, link: "https://prasathramakrishna.github.io/Secondhand-book-shopping/onlinebook/book.html" },
    { id: 4, title: "CGPA Calculation", description: "Accurately tracks CGPA with user-friendly input and real-time results.", image: image4, link: "https://prasathramakrishna.github.io/cgpa-calculator/loginpage.html" },
  ];
  ...
  return (
    <Router>
      ...
      <div className="projects" id="projects">
        ...
        <div className='see'>
          <button className='more'><MdOutlineKeyboardDoubleArrowDown />See More</button>
        </div>
      </div>
      ...
      <div className="foot-title" id="contact">Contact</div>
      <Footer />
